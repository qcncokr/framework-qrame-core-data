...
namespace Qrame.CoreFX.Data.Client
{
    ...
    /// 주요 기능으로 다음과 같습니다.
    /// <code>
    ///   using (SQLiteiteClient dbClient = new SQLiteiteClient())
    ///   {
    ...
    public sealed class SQLiteClient : IDisposable
    {
        ...
        /// <summary>
        /// SQLiteServer 닷넷 프레임워크의 데이터 공급자의 기능을 동일 하게 제공하는 Factory 클래스입니다.
        /// </summary>
        ...
        /// <summary>
        /// 현재 연결에 대한 통계 수집이 활성화됩니다. 연결에 대한 통계 수집은 System.Data.SQLiteClient.SQLiteConnection 만 지원 합니다.
        ...
        /// </summary>
        /// <returns>메서드가 호출된 시점에서 통계의 이름 값 쌍 컬렉션을 반환합니다. SQLiteConnection 이외의 연결 객체에 대해서는 null값을 반환 합니다.</returns>
        ...
        /// </summary>
        /// <param name="toDbType">닷넷 프레임워크 데이터 공급자의 필드, 속성 또는 SQLiteParameter 개체의 데이터 형식을 지정합니다.</param>
        /// <param name="parameterName">SQLiteParameter 개체의 매개 변수 이름입니다.</param>
        /// <param name="value">SQLiteParameter 개체의 매개 변수 값입니다.</param>
        ...
        /// <param name="parameterName">SQLiteParameter 개체의 매개 변수 이름입니다.</param>
        /// <param name="value">SQLiteParameter 개체의 매개 변수 값입니다.</param>
        /// <param name="direction">SQLiteParameter 개체의 매개 변수의 형식입니다.</param>
        /// <returns>DbCommand에 대한 매개 변수입니다.</returns>
        public SQLiteParameter CreateParameter(DbType toDbType, string parameterName, object value, ParameterDirection direction)
        {
            ...
            if (parameter == null)
            {
                ...
                ExceptionFactory.Handle("SQLiteiteClient 공급자에서 SQLiteParameter 개체를 생성하지 못했습니다.", new Exception());
            }
        ...
        /// <summary>
        /// 제네릭 SQLiteParameter 컬렉션에 등록된 정보로, SQL Server 제공자에게 명령을 수행할 SQL 문자열을 반환하며, 데이터베이스 제공자에게 아무런 작업을 수행하지 않습니다.
        /// </summary>
        /// <param name="procedureName">쿼리 명령을 생성할 procedureName명 입니다.</param>
        /// <param name="parameters">제네릭 SQLiteParameter 컬렉션 객체 입니다</param>
        ...
        /// <param name="commandText">쿼리 명령을 수행할 ANSI SQL 또는 T-SQL 문자열입니다.</param>
        /// <param name="dbCommandType">명령 문자열을 해석하는 방법을 지정합니다.</param>
        /// <param name="parameters">procedureName의 매개 변수를 구성할, 제네릭 SQLiteParameter 컬렉션입니다.</param>
        /// <returns>commandText 결과를 DataSet 타입으로 반환합니다.</returns>
        ...
        /// <param name="connectionState">명령 수행후 Database 연결 상태를 지정할 connectionState 열거자 입니다.</param>        
        /// <returns>commandText 결과를 DataSet 타입으로 반환합니다.</returns>
        public DataSet ExecuteProcedureFmtOnly(string procedureName, CommandType dbCommandType, List<SQLiteParameter> parameters, ExecutingConnectionState connectionState)
        {
        ...
        /// <summary>
        /// SQL Server 제공자에 commandText문을 수행 하여 SQLiteDataReader를 반환 합니다. ANSI SQL 또는 T-SQL을 사용합니다.
        /// SQLiteDataReader 사용이 끝난 후에는 SQLiteiteClient 인스턴스의 Dispose() 메서드를 명시적으로 호출해야 Database 연결을 해제 합니다.
        /// </summary>
        /// <param name="commandText">쿼리 명령을 수행할 ANSI SQL 또는 T-SQL 문자열입니다.</param>
        /// <param name="dbCommandType">명령 문자열을 해석하는 방법을 지정합니다.</param>
        /// <returns>commandText 결과를 SQLiteDataReader 타입으로 반환합니다.</returns>
        ...
        /// <summary>
        /// 지정된 procedureName문의 SQLiteParameter 컬렉션을 반환합니다.
        /// </summary>
        /// <param name="procedureName">SQLiteParameter 컬렉션을 반환할 procedureName명 입니다.</param>
        /// <returns>procedureName문의 SQLiteParameter 컬렉션입니다.</returns>
        private SQLiteParameter[] GetSpParameterSet(string procedureName)
        {
            ...
            {
                parameters[i] = result[i] as SQLiteParameter;
            }
        ...
        /// <summary>
        /// Factory의 DatabaseCommand객체에 SQLiteParameter를 구성합니다.
        /// </summary>
        /// <param name="procedureName">쿼리 명령을 수행할 procedureName명 입니다.</param>
        /// <param name="parameters">procedureName의 매개 변수를 구성할, 제네릭 SQLiteParameter 컬렉션입니다.</param>
        ...
        /// <summary>
        /// 제네릭 SQLiteParameter 컬렉션의 데이터를 기준으로, SQLiteParameter에 값을 입력 합니다.
        /// </summary>
        /// <param name="parameter">parameter 타입입니다.</param>
        /// <param name="ListParameters">SQLiteParameter 컬렉션 타입입니다.</param>
        ...
        /// <summary>
        /// SQLiteiteClient에서 사용하는 리소스(메모리 제외)를 삭제합니다.
        /// </summary>
        public void Dispose()
        {
            Dispose(true);
        ...
        /// <summary>
        /// SQLiteiteClient의 리소스를 선택적으로 해제합니다.
        /// </summary>
